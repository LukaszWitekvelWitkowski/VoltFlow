...
{
    public class GetElementGroupsHandler : IRequestHandler<GetElementGroupsQuery, ServiceResponse<ElementGroupsDTO>>
    {
        ...
        public async Task<ServiceResponse<ElementGroupsDTO>> Handle(GetElementGroupsQuery request, CancellationToken cancellationToken)
        {
